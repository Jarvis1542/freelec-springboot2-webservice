package com.jojoldu.book.springboot.springboot.service;

import com.jojoldu.book.springboot.springboot.domain.posts.Posts;
import com.jojoldu.book.springboot.springboot.domain.posts.PostsRepository;
import com.jojoldu.book.springboot.springboot.web.dto.PostsListResponseDto;
...
public class PostsService {
    ...
    @Transactional(readOnly = true) // 트랜잭션 범위는 나두고, 조회기능만 남겨서 성능향상
